define([
...
], function(_, BubbleChart, ApiResponse, ApiQuery, MinSub) {
  var data = {
    responseHeader: {
      status: 0,
      QTime: 1478,
      ...
      docs: [
        {
          ...
          read_count: 11.0,
          title: [
            'Dynamically generated resonances from the vector octet-baryon octet interaction with strangeness zero',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Anaerobic nitrification-denitrification mediated by Mn-oxides in meso-tidal sediments: Implications for N<SUB>2</SUB> and N<SUB>2</SUB>O production',
          ],
        },
        {
          read_count: 3.0,
        ...
        },
        {
          ...
          title: [
            'Electrical, magnetic, and direct and converse magnetoelectric properties of (1-x)Pb(Zr<SUB>0.52</SUB>Ti<SUB>0.48</SUB>)O<SUB>3</SUB>-(x)CoFe<SUB>2</SUB>O<SUB>4</SUB> (PZT-CFO) magnetoelectric composites',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Large-eddy simulation of the hurricane boundary layer: Evaluation of the planetary boundary-layer parametrizations',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Corrigendum to “Comets formed in solar-nebula instabilities! - An experimental and modeling attempt to relate the activity of comets to their formation process” [Icarus 235 (2014) 156-169]',
          ],
        },
        {
          read_count: 7.0,
        ...
        },
        {
          ...
          title: [
            'Antiferromagnetic superexchange interaction between Fe<SUP>3+</SUP> ions in Fe<SUP>3+</SUP> doped wide-gap oxide of β-Ga<SUB>2-x</SUB>Fe<SUB>x</SUB>O<SUB>3</SUB> (x=0.1, 0.2, 0.3, 0.4)',
          ],
        },
        {
          read_count: 6.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Gas phase dicyanoacetylene (C<SUB>4</SUB>N<SUB>2</SUB>) on Titan: New experimental and theoretical spectroscopy results applied to Cassini CIRS data',
          ],
        },
        {
          read_count: 6.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Physical modeling of triple near-Earth Asteroid (153591) 2001 SN<SUB>263</SUB> from radar and optical light curve observations',
          ],
        },
        {
          pubdate: '2015-03-00',
        ...
        },
        {
          ...
          title: [
            'Non-double-couple mechanism of moderate earthquakes occurred in Lower Siang region of Arunachal Himalaya: Evidence of factors affecting non-DC',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Petrogenesis of carbonated meta-ultramafic lenses from the Neoproterozoic Heiani ophiolite, South Eastern Desert, Egypt: A natural analogue to CO<SUB>2</SUB> sequestration',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Enhancement in photocatalytic activity of NiO by supporting onto an Iranian clinoptilolite nano-particles of aqueous solution of cefuroxime pharmaceutical capsule',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Fast lithium intercalation chemistry of the hierarchically porous Li<SUB>2</SUB>FeP<SUB>2</SUB>O<SUB>7</SUB>/C composite prepared by an iron-reduction method',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'The absorption spectrum of <SUP>13</SUP>CH<SUB>4</SUB> in the region of the 2ν<SUB>3</SUB> band at 1.66 μm: Empirical line lists and temperature dependence',
          ],
        },
        {
          read_count: 0.0,
          ...
          title: [
            'Characterization of mixed titanium-niobium oxide Ti<SUB>2</SUB>Nb<SUB>10</SUB>O<SUB>29</SUB> annealed in vacuum as anode material for lithium-ion battery',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'How well do satellite AOD observations represent the spatial and temporal variability of PM<SUB>2.5</SUB> concentration for the United States?',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Seismically-induced mass movements and volumetric fluxes resulting from the 2010 M<SUB>w</SUB> = 7.2 earthquake in the Sierra Cucapah, Mexico',
          ],
        },
        {
          read_count: 0.0,
          ...
          title: [
            'Ship-based MAX-DOAS measurements of tropospheric NO<SUB>2</SUB> and SO<SUB>2</SUB> in the South China and Sulu Sea',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Influence of deep-water derived isoprenoid tetraether lipids on the 〈mml:msubsup〉TEX 86 H paleothermometer in the Mediterranean Sea',
          ],
        },
        {
          read_count: 2.0,
          ...
          citation_count: 0,
          title: [
            'A kinetic pressure effect on the experimental abiotic reduction of aqueous CO<SUB>2</SUB> to methane from 1 to 3.5 kbar at 300 °C',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Linear analysis on the onset of thermal convection of highly compressible fluids: implications for the mantle convection of super-Earths',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Rate of fluvial incision in the Central Alps constrained through joint inversion of detrital <SUP>10</SUP>Be and thermochronometric data',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Detection and characterization of transient forcing episodes affecting earthquake activity in the Aleutian Arc system',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Experimental evidence for kinetic effects on B/Ca in synthetic calcite: Implications for potential B(OH)<SUB>4</SUB><SUP>-</SUP> and B(OH)<SUB>3</SUB> incorporation',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          title: [
            'U-Pb zircon geochronology, geochemical and Sr-Nd-Hf isotopic compositions of the Early Indosinian Tongren Pluton in West Qinling: Petrogenesis and geodynamic implications',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Shortening of the European Dauphinois margin (Oisans Massif, Western Alps): New insights from RSCM maximum temperature estimates and <SUP>40</SUP>Ar/<SUP>39</SUP>Ar in situ dating',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Reconstruction of magmatic variables governing recent Etnean eruptions: Constraints from mineral chemistry and P-T-fO<SUB>2</SUB>-H<SUB>2</SUB>O modeling',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Petrogenesis and tectonic implications of the early Jurassic Fe-Ti oxide-bearing Xialan mafic intrusion in SE China: Constraints from zircon Hf-O isotopes, mineral compositions and whole-rock geochemistry',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Investigation of phase formation of (Zn, Mg)<SUB>0.5</SUB>Co<SUB>0.5</SUB>Fe<SUB>2</SUB>O<SUB>4</SUB> nanoferrites',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Evidence of loss of active lithium in titanium-doped LiNi<SUB>0.5</SUB>Mn<SUB>1.5</SUB>O<SUB>4</SUB>/graphite cells',
          ],
        },
        {
          read_count: 0.0,
          ...
          title: [
            'The effect of SiO<SUB>2</SUB>/Al<SUB>2</SUB>O<SUB>3</SUB> ratio on the structure and microstructure of the glazes from SiO<SUB>2</SUB>-Al<SUB>2</SUB>O<SUB>3</SUB>-CaO-MgO-Na<SUB>2</SUB>O-K<SUB>2</SUB>O system',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Direct synthesis of trirutile-type LiMgFeF<SUB>6</SUB> and its electrochemical characterization as positive electrode in lithium-ion batteries',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Influence of springtime biomass burning in South Asia on regional ozone (O<SUB>3</SUB>): A model based case study',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'SiO<SUB>x</SUB>-C dual-phase glass for lithium ion battery anode with high capacity and stable cycling performance',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Polyhedral ordered LiNi<SUB>0.5</SUB>Mn<SUB>1.5</SUB>O<SUB>4</SUB> spinel with excellent electrochemical properties in extreme conditions',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Electrical transport properties of nanocrystalline nonstoichiometric nickel ferrite at and above room temperature',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'A complexity analysis of <SUP>222</SUP>Rn concentration variation: A case study for Domica cave, Slovakia for the period June 2010-June 2011',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'The role of dew in the monsoon season assessed via stable isotopes in an alpine meadow in Northern Tibet',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Formation of self-supporting porous graphite structures by Spark Plasma Sintering of nickel-amorphous carbon mixtures',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 2,
          title: [
            'Application of surface pressure measurements from O<SUB>2</SUB>-band differential absorption radar system in three-dimensional data assimilation on hurricane: Part I - An observing system simulation experiments study',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'The dynamical effects of an outer planet on the evolution and observability of Kepler-11-like systems',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          title: [
            'Regional characteristics of the relationship between columnar AOD and surface PM<SUB>2.5</SUB>: Application of lidar aerosol extinction profiles over Baltimore-Washington Corridor during DISCOVER-AQ',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Development of Cu<SUB>1.3</SUB>Mn<SUB>1.7</SUB>O<SUB>4</SUB> spinel coating on ferritic stainless steel for solid oxide fuel cell interconnects',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Effects of three different homemade nanocarbons doping on the superconducting properties of MgB<SUB>2</SUB> tapes',
          ],
        },
        {
          read_count: 0.0,
          ...
          title: [
            'XPS study of the chemical stability of DyBa<SUB>2</SUB>Cu<SUB>3</SUB>O<SUB>6+δ</SUB> superconductor',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Oxidation and microstructure evolution of Al-Si coated Ni<SUB>3</SUB>Al based single crystal superalloy with high Mo content',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'U-Pb, <SUP>39</SUP>Ar/<SUP>40</SUP>Ar geochronology of the metamorphosed volcanic rocks of the Bainaimiao Group in central Inner Mongolia and its implications for ore genesis and geodynamic setting',
          ],
        },
        {
          read_count: 0.0,
          ...
          title: [
            'Geochronology and geochemistry of Late Devonian and early Carboniferous igneous rocks of central Jilin Province, NE China: Implications for the tectonic evolution of the eastern Central Asian Orogenic Belt',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Average landslide erosion rate at the watershed scale in southern Taiwan estimated from magnitude and frequency of rainfall',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Condensation-corrosion speleogenesis above a carbonate-saturated aquifer: Devils Hole Ridge, Nevada',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Source and distribution of organic matter in sediments in the SE Brazilian continental shelf influenced by river discharges: An approach using stable isotopes and molecular markers',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Synthesis and electrochemical properties of novel LiFeTiO<SUB>4</SUB> and Li<SUB>2</SUB>FeTiO<SUB>4</SUB> polymorphs with the CaFe<SUB>2</SUB>O<SUB>4</SUB>-type structures',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'The halogen (F, Cl, Br, I) and H<SUB>2</SUB>O systematics of Samoan lavas: Assimilated-seawater, EM2 and high-<SUP>3</SUP>He/<SUP>4</SUP>He components',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Herschel Planetary Nebula Survey (HerPlaNS): First Detection of OH<SUP>+</SUP> in Planetary Nebulae',
          ],
        },
        {
          read_count: 5.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Lithium ion conductive Li<SUB>1.5</SUB>Al<SUB>0.5</SUB>Ge<SUB>1.5</SUB>(PO<SUB>4</SUB>)<SUB>3</SUB> based inorganic-organic composite separator with enhanced thermal stability and excellent electrochemical performances in 5 V lithium ion batteries',
          ],
        },
        {
          read_count: 3.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Caught in the Act: Imaging the Disk and Outflows in V Hya, a carbon-rich AGB star in transition to a Bipolar Pre-Planetary Nebula',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          title: [
            'Li<SUB>2</SUB>S nanocomposites underlying high-capacity and cycling stability in all-solid-state lithium-sulfur batteries',
          ],
        },
        {
          read_count: 3.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            "Corrigendum to 'Evidence for shock heating and constraints on Martian surface temperatures revealed by <SUP>40</SUP>Ar/<SUP>39</SUP>Ar thermochronometry of Martian meteorites' [Geochim. Cosmochim. Acta (2010) 6900-6920]",
          ],
        },
        {
          read_count: 8.0,
        ...
        },
        {
          ...
          title: [
            'Facile fabrication of hydrophobic surfaces on mechanically alloyed-Mg/HA/TiO<SUB>2</SUB>/MgO bionanocomposites',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Synthesis, structural and electrical properties of a new cobalt arsenate NaCo<SUB>2</SUB>As<SUB>3</SUB>O<SUB>10</SUB>',
          ],
        },
        {
          read_count: 0.0,
          ...
          citation_count: 0,
          title: [
            'Synthesis, crystal structure and electrical proprieties of new phosphate KCoP<SUB>3</SUB>O<SUB>9</SUB>',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Processes controlling δ<SUP>7</SUP>Li in rivers illuminated by study of streams and groundwaters draining basalts',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Disequilibrium degassing model determination of the <SUP>3</SUP>He concentration and <SUP>3</SUP>He/<SUP>22</SUP>Ne of the MORB and OIB mantle sources',
          ],
        },
        {
          read_count: 4.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Spatio-temporal characteristics of the Equatorial Ionization Anomaly (EIA) in the East African region via ionospheric tomography during the year 2012',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Isotope fractionation induced by phase transformation: First-principles investigation for Mg<SUB>2</SUB>SiO<SUB>4</SUB>',
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Emerging Trends Gleaned from Central Star and Hot Bubble X-ray Emission of ChanPlaNS Planetary Nebulae',
          ],
        },
        {
          read_count: 3.0,
        ...
        },
        {
          ...
          title: [
            'The HerPlaNS far-IR photometric survey of Planetary Nebulae and its contribution to the Emerging Multi-wavelength View',
          ],
        },
        {
          read_count: 2.0,
        ...
        },
        {
          ...
          title: [
            "Response to: Comment on 'Synchronous records of pCO<SUB>2</SUB> and Δ<SUP>14</SUP>C suggest rapid, ocean-derived pCO<SUB>2</SUB> fluctuations at the onset of Younger Dryas' (Steinthorsdottir et al., 2014, Quaternary Science Reviews 99, 84-96)",
          ],
        },
        {
          read_count: 0.0,
        ...
        },
        {
          ...
          title: [
            'Synthesis, structure and conductivity studies of co-doped ceria: CeO<SUB>2</SUB>-Sm<SUB>2</SUB>O<SUB>3</SUB>-Ta<SUB>2</SUB>O<SUB>5</SUB> (Nb<SUB>2</SUB>O<SUB>5</SUB>) solid solution',
          ],
        },
        {
          read_count: 9.0,
        ...
        },
        {
          ...
          title: [
            'Book Review: Late Cenozoic Climate Change in Asia: Loess, Monsoon and Monsoon-arid Environment Evolution',
          ],
        },
        {
          read_count: 3.0,
        ...
        },
        {
          ...
          citation_count: 0,
          title: [
            'Ice core profiles of saturated fatty acids (C<SUB>12:0</SUB>-C<SUB>30:0</SUB>) and oleic acid (C<SUB>18:1</SUB>) from southern Alaska since 1734 AD: A link to climate change in the Northern Hemisphere',
          ],
        },
        {
          read_count: 0.0,
          ...
          citation_count: 0,
          title: [
            'Glacial cooling as inferred from marine temperature proxies TEX<SUP>H</SUP><SUB>86</SUB> and U<SUP>K′</SUP><SUB>37</SUB>',
          ],
        },
        {
          read_count: 2.0,
          ...
          citation_count: 0,
          title: [
            'Distinguishing between basalts produced by endogenic volcanism and impact processes: A non-destrwuctive method using quantitative petrography of lunar basaltic samples',
          ],
        },
        {
          read_count: 0.0,
  ...
  describe('Bubble Chart (UI Widget)', function() {
    ...
    it('should parse each record', function() {
      ...
      _.each(
        bubble.model.get('data'),
        function(d) {
          //valid date
          if (
            !(Object.prototype.toString.call(d.date) === '[object Date]') ||
    ...
    it('should have a reads vs time version', function() {
      ...
      expect(
        d3.selectAll('.paper-circle').filter(function(d) {
          return d.bibcode == '2000hst..prop.8482L';
        })[0].length
      ).to.eql(0);
      var testBib = d3.selectAll('.paper-circle').filter(function(d) {
        return d.bibcode == '1999AJ....117..343R';
      });
    ...
    it('should have a citations vs reads version', function(done) {
      ...
      setTimeout(function() {
        ...
        var expected = _.chain(data.response.docs)
          .filter(function(d) {
            if (d.read_count >= 1) {
              return true;
            }
    ...
    it('should allow the user to select bibodes and filter on them', function() {
      ...
      expect(JSON.stringify(bubble.getPubSub().publish.args[0][2].q.toJSON())).to.eql(
        '{"q":["fake"],"fq_bubble_chart":["(bibcode:(2000hst..prop.8482L OR 1999AJ....117..343R))"],"__bubble_chart_fq_bubble_chart":["AND","bibcode:(2000hst..prop.8482L OR 1999AJ....117..343R)"],"fq":["{!type=aqp v=$fq_bubble_chart}"]}'
      );
    });
    ...
    it('should have a tooltip', function() {
      ...
      expect(normalizeSpace($('.d3-tooltip').text())).to.eql(
        'Brown Dwarfs in the Hyades and Beyond? (1999AJ....117..343R) Citations: 44, Reads: 3'
      );
    });
    ...
    it('should detect if a log scale is impossible, and both default to linear and remove the log option entirely', function() {
      ...
      expect(
        _.pluck(
          d3.selectAll('.paper-bubble').each(function() {
