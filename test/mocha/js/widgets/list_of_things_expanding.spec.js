    ...
    var test = function () {
      describe("ListOfThings (list_of_things_expanding.spec.js)", function () {
        ...
        it("should know to load more results", function (done) {
          ...
          expect($(".identifier").eq(0).text().trim()).to.equal("2013arXiv1305.3460H");
          ...
          setTimeout(
            function() {
              ...
              expect($(".identifier").eq(13).text().trim()).to.equal("1978GeoRL...5..294C");
              ...
              expect($(".identifier").eq(17).text().trim()).to.equal("1982LPSC...13..260D");
