define([
...
], function(UserSettings, MinSub, User, Session) {
  describe('User Settings Widget (user_settings_widget.spec.js)', function() {
    ...
    it("should listen to submit clicks and call the user's postData method", function() {
      ...
      expect(JSON.stringify(fakeUser.changePassword.args[0])).to.eql(
        '[{"old_password":"Foooo5","new_password1":"Boooo3","new_password2":"Boooo3"}]'
      );
    });
