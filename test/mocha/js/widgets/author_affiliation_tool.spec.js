      ...
      describe('renders for current query', function () {
        ...
        it('updates the table with data', function (done) {
          ...
          _.delay(function () {
            ...
            _.delay(function () {
              var el = Enzyme.render(com);
              var text = el.text().replace(/From\s\d{4}\sto\s\d{4}/, '');
              expect(text).to.eql(mockTable);
              done();
            }, 15);
          }, 15);
        });
