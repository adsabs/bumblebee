define([
...
], function(GraphicsWidget, JsonResponse, ApiRequest, MinPubSub) {
  describe('Graphics Widget', function() {
          ...
          images: [
            {
              format: 'gif',
              highres:
                'http://www.astroexplorer.org/details/10_1086_309555_fg1',
              image_id: '10_1086_309555_fg1',
              thumbnail:
                'https://s3.amazonaws.com/aasie/images/1538-4357/447/1/L37/10_1086_309555_fg1_tb.gif',
            },
          ],
        },
        {
          ...
          images: [
            {
              format: 'gif',
              highres:
                'http://www.astroexplorer.org/details/10_1086_309555_fg2',
              image_id: '10_1086_309555_fg2',
              thumbnail:
                'https://s3.amazonaws.com/aasie/images/1538-4357/447/1/L37/10_1086_309555_fg2_tb.gif',
            },
          ],
        },
        {
          ...
          images: [
            {
              format: 'gif',
              highres:
                'http://www.astroexplorer.org/details/10_1086_309555_fg3',
              image_id: '10_1086_309555_fg3',
              thumbnail:
                'https://s3.amazonaws.com/aasie/images/1538-4357/447/1/L37/10_1086_309555_fg3_tb.gif',
            },
          ],
        },
        {
          ...
          images: [
            {
              format: 'gif',
              highres:
                'http://www.astroexplorer.org/details/10_1086_309555_fg4',
              image_id: '10_1086_309555_fg4',
              thumbnail:
                'https://s3.amazonaws.com/aasie/images/1538-4357/447/1/L37/10_1086_309555_fg4_tb.gif',
            },
          ],
        },
      ],
      header:
        'Every image links to the <a href="http://www.astroexplorer.org/" target="_new">IOP "Astronomy Image Explorer"</a> for more detail.',
      id: 9,
      modtime: null,
      number: 4,
      pick:
        '<a href="graphics" border=0><img src="https://s3.amazonaws.com/aasie/images/1538-4357/447/1/L37/10_1086_309555_fg2_tb.gif"></a>',
      query: 'OK',
      query_class: null,
      source: 'IOP',
      widgets: [
    ...
    it('requests graphics data from graphics endpoint and title data from search endpoint, then resolves/rejects deferred for toc widget', function() {
      ...
      let apiRequest, graphicsRequest;
      ...
      minsub.beehive.addObject('DocStashController', { getDocs: () => [] });
      ...
      g.onDisplayDocuments(
        new minsub.createQuery({ q: 'identifier:fakeBibcode' })
      );
      ...
      expect(apiRequest.get('query').toJSON().q).to.eql([
        'identifier:fakeBibcode',
      ]);

      expect(eventSpy.args[0][0]).to.eql('widget-ready');
      expect(eventSpy.args[0][1].isActive).to.eql(true);
      expect(eventSpy.args[1][0]).to.eql('widget-ready');
      expect(eventSpy.args[1][1].isActive).to.eql(true);
      ...
      g.onDisplayDocuments(
        new minsub.createQuery({ q: 'identifier:fakeBibcode2' })
      );

      expect(eventSpy.callCount).to.eql(4);
      expect(eventSpy.args[2][1].shouldReset).to.eql(true);
      expect(eventSpy.args[2][1].isActive).to.eql(false);
    ...
    it('by default renders a grid of images', function() {
      ...
      expect($(' .s-graphics-grid a:nth-of-type(2)').attr('href')).to.eql(
        'http://www.astroexplorer.org/details/10_1086_309555_fg2'
      );
    ...
    it('can also have a variant that renders a single thumbnail and, when clicked, triggers a nav event to the main widget', function() {
      ...
      expect(normalizeSpace($('.s-graphics-sidebar').html())).to.eql(
        '<div class="s-right-col-widget-container"> <div class="graphics-container s-graphics-container"> <h4 class="s-right-col-widget-title">Graphics</h4> <div class="grid-cell"> <img src="https://s3.amazonaws.com/aasie/images/1538-4357/447/1/L37/10_1086_309555_fg1_tb.gif" alt="figure from paper" class="grid-cell__image"> <p><i>Click to view more</i></p> </div> </div> </div>'
      );

      var spy = sinon.spy();
      g.getPubSub = function() {
