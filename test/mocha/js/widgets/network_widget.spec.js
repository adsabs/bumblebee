define([
  ...
  describe('Network Visualization Widget (network_widget.spec.js)', function() {
    ...
    testDataLarge = {
      data: {
        bibcode_dict: {
          ...
          '1981romi.work.....K': {
            authors: ['Jannaway, W', 'Kurtz, M', 'Stone, G'],
            citation_count: 0,
            read_count: 0,
          ...
          '1989daa..conf..155K': {
            authors: ['Falco, E', 'Kurtz, M'],
            citation_count: 0,
            read_count: 0,
            title:
              'Tests of Reduction and Analysis Algorithms for Astronomical Images',
          },
          '1990PaReL..11..507K': {
            authors: ['Kurtz, M', 'Mussio, P', 'Ossorio, P'],
            citation_count: 1,
            read_count: 0,
          ...
          '1992IAUTB..21..331K': {
            ...
            read_count: 0,
            title:
              'The Need for Automation in the Reduction and Analysis of Stellar Spectra',
          },
          '1993AAS...182.0306K': {
            authors: [
              'Eichhorn, G',
          ...
          '1997DPS....29.2705K': {
            ...
            read_count: 2.0,
            title:
              'The IAU Circulars and Minor Planet Electronic Circulars are Now Available Through the NASA Astrophysics Data System',
          },
          '1998AAS...193.1311K': {
            authors: [
              'Accomazzi, A',
          ...
          '1999AAS...194.4407K': {
            ...
            read_count: 2.0,
            title:
              'A Model for Readership of Astronomical Journals, From an Analysis of ADS Readership',
          },
          '1999Dlib....5.....K': {
            authors: [
              'Accomazzi, A',
          ...
          '2002AAS...201.0904K': {
            ...
            read_count: 0,
            title:
              'The NASA Astrophysics Data System: Bibliometrics Investigations',
          },
          '2002SPIE.4847..238K': {
            authors: [
              'Accomazzi, A',
          ...
          '2005AAS...207.3405K': {
            ...
            read_count: 2.0,
            title:
              'The significance of e-printed papers in Astronomy and Physics',
          },
          '2005IPM....41.1395K': {
            authors: [
              'Accomazzi, A',
          ...
          '2009astro2010P..28K': {
            authors: ['Accomazzi, A', 'Kurtz, M', 'Murray, S'],
            citation_count: 1,
            read_count: 13.0,
            title:
        ...
        link_data: [
          [2, 3, 26.999999999999968],
          [2, 45, 26.999999999999968],
          [2, 28, 10.189655172413781],
          [3, 9, 10.189655172413781],
          [3, 44, 26.999999999999968],
          [3, 42, 26.999999999999968],
          [3, 30, 30.36206896551721],
          [6, 38, 17.810344827586185],
          [9, 45, 10.189655172413781],
          [11, 30, 16.465517241379292],
          [15, 38, 29.689655172413758],
          [25, 38, 16.465517241379292],
          [28, 42, 10.189655172413781],
          [28, 44, 10.189655172413781],
          [28, 30, 27.224137931034452],
          [30, 45, 30.36206896551721],
          [32, 38, 29.689655172413758],
          [38, 43, 16.465517241379292],
          [42, 45, 26.999999999999968],
          [44, 45, 26.999999999999968],
        ],
        root: {
          children: [
            {
            ...
            },
            {
              children: [
                ...
                },
                {
                  ...
                  name: 'Wyatt, W',
                  numberName: 6,
                  papers: ['1992ASPC...25..432K', '2007AJ....134.1360K'],
                  read_count: 12.0,
                ...
                },
                {
                  ...
                  name: "Dell'Antonio, I",
                  numberName: 15,
                  papers: ['2007AJ....134.1360K', '2012ApJ...750..168K'],
                  read_count: 32.0,
              ...
              children: [
                {
                  ...
                  name: 'Huchra, J',
                  numberName: 0,
                  papers: ['1985AJ.....90.1665K', '1984BAAS...16..457K'],
                  read_count: 18.0,
              ...
              children: [
                {
                  ...
                  name: 'Stoner, J',
                  numberName: 2,
                  papers: ['1993ASPC...52..132K', '1993AAS...182.0306K'],
                  read_count: 3.0,
                  size: 5.554463017589861,
                },
                {
              ...
              children: [
                {
                  ...
                  name: 'Falco, E',
                  numberName: 23,
                  papers: ['1989daa..conf..155K', '1990ebua.conf..363K'],
                  read_count: 0,
              ...
              children: [
                {
                  ...
                  name: 'Regele, J',
                  numberName: 46,
                  papers: ['2014CTM....18..532K', '2014CTM....18..711K'],
                  read_count: 0,
                  size: 8.548563312575112,
                },
              ],
    ...
    testDataEmpty = {
      data: { fullGraph: { nodes: [], links: [] } },
      msg: { numFound: 0, rows: 0 },
    };
    ...
    it('communicates with pubsub to get current query info and to request network data', function() {
      var networkWidget = new NetworkWidget({
        networkType: 'author',
    ...
    it('renders a pie/sunburst chart if the data is large enough', function() {
      ...
      expect(
        normalizeSpace(
          $('#test')
            .find('.network-container')
            .text()
        )
      ).to.eql(normalizeSpace(expected1));
      ...
      ).to.eql(normalizeSpace(expected2));
      ...
      expect($('#test').find('.link').length).to.eql(
        testDataLarge.data.link_data.length
      );
      ...
      expect($('#test').find('.author-node').length).to.eql(
    ...
    it('allows you to click to view more data about a node or a group', function() {
      ...
      networkWidget.view.graphView.model.set(
        'selectedEntity',
        d3.select('.node-path')[0][0]
      );
      ...
      expect($('#test').find('.paper-description li').length).to.eql(
        bibcodes.length
      );
    ...
    it('has a filter capability that allows you to add or remove groups or individual nodes, and submit as a filter', function() {
      ...
      expect(
        normalizeSpace(
          $('#test')
            .find('.s-filter-names-container')
            .text()
        )
      ).to.eql('at least one member of Group 1 OR Accomazzi, A');

      $('#test')
        .find('button.filter-remove')
        .click();
      ...
      expect(
        $('#test')
          ...
          .text()
          .trim()
      ).to.eql('at least one member of Group 1');
      ...
      expect(networkWidget.getPubSub().publish.args[0][0]).to.eql(
        '[PubSub]-Custom-Event'
      );
      var xpected_bibs = [
        '2000A&AS..143...41K',
      ...
      var actualBibs = networkWidget.getPubSub().publish.args[0][2].ids || [];
      expect(actualBibs.sort()).to.eql(xpected_bibs.sort());
    });
    ...
    it("allows you to toggle between three arc sizing modes, and correctly calculates the arcs' size based on different variables", function() {
      ...
      var group1Path = $('#test')
        .find('g.node-containers:not(.author-node)')
        .eq(1)
        .find('path')
        .eq(0)[0];
      var group2Path = $('#test')
      ...
      expect(group1Path.__data__.value / group2Path.__data__.value).to.eql(
        sizeRatio
      );
    ...
    it('has a method to completely remove the graphView', function() {
      ...
      expect(
        _.keys(networkWidget.view.graphView._listeningTo).length
      ).not.be.eql(0);
    ...
    it('should allow the user to request a different number of documents', function(done) {
      ...
      expect(
        normalizeSpace(
          $('#test')
            .find('.network-metadata')
            .text()
        )
      ).to.eql(
        'Currently viewing data for 1000 papers. Change to first papers (max is 1000). Submit'
      );
      sinon.spy(networkWidget.getPubSub(), 'publish');
      $('#test')
        .find('.network-metadata input')
        .val('400');
      $('#test')
        .find('.network-metadata button.submit-rows')
        .trigger('click');

      setTimeout(function() {
        expect(networkWidget.getPubSub().publish.args[0][0]).to.eql(
          minsub.EXECUTE_REQUEST
        );
        expect(
          networkWidget
            .getPubSub()
        ...
        expect(
          ...
          'Currently viewing data for 400 papers. Change to first papers (max is 1000). Submit'
        );
        done();
      }, 800);
    });
          ...
          children: [
            {
              children: [
                {
                  papers: ['2000A&AS..143...41K', '1998ASPC...52..132K'],
                },
                {
                  papers: ['2005JASIS..56..111K'],
                },
            ...
            },
            {
              children: [
                {
                  papers: ['1985AJ.....90.1665B', '1984BAAS...16..457B'],
                },
                {
                  papers: ['1985AJ.....90.1665K', '1984BAAS...16..457K'],
                },
    ...
    it("should allow the user to hop to another author network from that author's detail page, while providing a back button", function() {
      ...
      expect(
        networkWidget
          .getPubSub()
          .publish.args[0][1].toJSON()
          .query.toJSON().query[0]
      ).to.eql(
        '{"q":["author:\\"Murray, S\\""],"rows":[400],"sort":["date desc"]}'
      );
      ...
      expect(networkWidget.getPubSub().publish.args[1][0]).to.eql(
        '[PubSub]-Execute-Request'
      );
      expect(
        networkWidget
          .getPubSub()
          .publish.args[1][1].toJSON()
          .query.toJSON().query[0]
      ).to.eql('{"q":["star"],"rows":[400],"sort":["date desc"]}');
    });
  });
});
