  ...
  describe('SIMBAD Object Facet Widget (simbad_object_facet.spec.js)', function() {
    describe('Main Widget', function() {
      ...
      it('state is update after loading data', function(done) {
        ...
        hierarchicalResponse.facet_counts.facet_fields.simbad_object_facet_hier = [
          '1/Galaxy/529086',
          5,
          '1/Galaxy/3133169',
          10,
        ...
        w.store.dispatch(
          w.actions.data_received(hierarchicalResponse, '0/Galaxy')
        );
      ...
      it('state is updated for render for query', function(done) {
        ...
        const galaxyProp = ObjectSolrResponse(1).facet_counts.facet_fields
          .simbad_object_facet_hier;
