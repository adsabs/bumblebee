    ...
    var test = function () {
      ...
      describe("Orcid Widget (orcid_widget.spec.js)", function () {
        ...
        it("Should display records coming from ORCID and has methods to filter/sort them", function (done) {
          ...
          sinon.stub(orcidApi, 'hasAccess', function () {
            return true
          });
          ...
          widget.collection.models[0].set({
            title: 'Tecnologias XXX',
            orcid: {provenance: 'ads'}
          });
          widget.collection.models[1].set({
            title: 'ADS 2.0',
            orcid: {provenance: 'others'}
          });
          widget.collection.models[2].set({
            title: 'External article',
            orcid: {provenance: null}
          });
