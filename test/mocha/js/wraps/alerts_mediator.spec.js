define([
  ...
  describe("Alerts Mediator (wraps/alerts_mediator.spec.js)", function () {
    ...
    it("registers itself", function (done) {
      ...
      setTimeout(function() {
        expect(m.onAppStart.called).to.be.true;
    ...
    it("gets and displays site-wide message", function (done) {
      ...
      expect(m.alert.lastCall.args[0].msg).to.eql('foo bar (<a id="dismissSiteWideMsg" href="foo">dismiss</a>)');
      ...
      $w.find('a#dismissSiteWideMsg').click();
