  ...
  var test = function () {
    describe("Multi Params (API)", function () {
      ...
      it("can be serialized and de-serialized (saved as string and reloaded)", function() {
        ...
        expect(t.url()).to.equal('foo=%7B!type%3Daqp%20fq%3Dtitle%20v%3D%24vv%7D&vv=title%3Afoo' );

        t = new MultiParams().load('foo=%7B!type%3Daqp%20fq%3Dtitle%20v%3D%24vv%7D&vv=title%3Afoo' );
