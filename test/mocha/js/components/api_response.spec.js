define([
  'js/components/api_response', 'backbone', 'jquery'
], function (Response, Backbone, $) {
  ...
  var test = function () {
    describe("ApiResponse Object (API)", function () {
      ...
      it('has simple api to retrieve values (keys/values, of unlimited structure)', function () {
        ...
        expect(function () {
          rsp.get('response["docs"]["0]')
        }).to.throw(Error);
        expect(function () {
          rsp.get('response["docs"][10]')
        }).to.throw(Error);
        expect(function () {
          rsp.get('response["docs"][-1]')
        }).to.throw(Error);
      ...
      it("is not forgiving (accessing unknown keys is throwing error)", function () {
        expect(function () {
          new Response(this.jsonData).get('foo.bar');
        }).to.throw(Error);
