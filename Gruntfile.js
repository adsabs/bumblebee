module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      move_fontawesome : {
        cmd : 'cp -r bower_components/fontawesome/fonts/ src/styles/fonts/; mkdir -p src/styles/fonts/fontawesome/; cp -r bower_components/fontawesome/less/ src/styles/fonts/fontawesome'
      },
      move_jqueryuicss : {
