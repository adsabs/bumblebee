        ...
        <div>
          ...
          { !disableControls &&
            <div className="form-group btn-toolbar">
              <button id="addLibrary" className="btn btn-default btn-sm" disabled={count >= max} onClick={e => this.updateCount(e, 1)}>
                <fa className={`fa fa-${addIcon}`}/> {addLabel}
              </button>
              { count > 1 &&
              <button id="removeLibrary" className="btn btn-danger btn-sm" onClick={e => this.updateCount(e, -1)}>
