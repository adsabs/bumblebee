...
define(['js/widgets/base/base_widget',
    'js/components/api_query', 'hbs!./templates/export-button',
    'hbs!./templates/export-menu'],
  function(BaseWidget, ApiQuery, ButtonTemplate, MenuTemplate){
  ...
  ExportWidget = BaseWidget.extend({
