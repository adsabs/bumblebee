    ...
    if (docs.length === 0) {
      return (
        <Message>
          ...
          reading history, and we suggest that you create an ADS account to take advantage of this feature. If you
          already have an account, then be sure you are logged in while searching and reading papers. In due time we
          will be able to provide you with suggestions based on your inferred interests.
        </Message>
      );
    }
